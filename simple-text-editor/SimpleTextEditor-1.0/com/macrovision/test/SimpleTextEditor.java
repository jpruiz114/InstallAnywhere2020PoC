...
public class SimpleTextEditor extends JFrame {
    ...
    private static final String title = "Simple Text Editor 1.0";
    ...
    private void initialize() {
        ...
        String initialHeight = (String) prop.get("initial.height");
        String initialWidth = (String) prop.get("initial.width");

        this.setContentPane(getJContentPane());
        this.setSize(new Integer(initialWidth).intValue(), new Integer(initialHeight).intValue());
        this.setTitle(title);

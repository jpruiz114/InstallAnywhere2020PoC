...
public class CustomJavaActionBase extends CustomCodeAction {
    private void pause() {
        try {
    ...
    public void install(InstallerProxy installerProxy) throws InstallException {
        ...
        String filePath = System.getProperty("user.home") + System.getProperty("file.separator") + dateTimeString + "_" + "installing_" + productVersionName + ".txt";
    ...
    public void uninstall(UninstallerProxy uninstallerProxy) throws InstallException {
        ...
        String filePath = System.getProperty("user.home") + System.getProperty("file.separator") + dateTimeString + "_" + "uninstalling_base_" + productVersionName + ".txt";
        ...
        try {
            ...
            bu.backupFolderOnUninstall(uninstallerProxy);
        } catch (Exception e) {
